...
import github.comioko.articlepilot.config.PexelsConfig;
...
import static github.comioko.articlepilot.constant.ArticleConstant.*;
...
public class PexelsService implements ImageSearchService {
    ...
    public String searchImage(String keywords) {
        ...
        if (apiKey == null || apiKey.isBlank() || "PLACEHOLDER".equals(apiKey)) {
            log.warn("Pexels api-key 未配置（设置环境变量 PEXELS_API_KEY 后生效），本次跳过 Pexels 检索");
            return null;
        }
        try {
